...
/*   Updated: 2023/03/29 02:08:06 by jewancti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_gameplay(t_data *data)
{
	...
	while (++x < WIDTH)
	{
		...
		data->params.ray_x = data->params.dir_y + data->params.plane_y * ca_x;
		data->params.ray_y = data->params.dir_x + data->params.plane_x * ca_x;
